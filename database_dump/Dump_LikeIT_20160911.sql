...
INSERT INTO `comment` VALUES (1,'izzi',2,'Интерфейс - это контракт, которому должен удовлетворять класс','2016-08-01 22:13:51',1,9,0),(2,'dasha',2,'А можно простыми словами?(','2016-08-02 14:59:22',0,5.75,0),(3,'izzi',2,'Вы правы. Просто список методов, которые должны быть реализованы','2016-08-02 17:00:18',1,0,0),(4,'dasha',2,'Спасибо','2016-08-02 21:11:47',0,9,0),(5,'dasha',4,'скорее всего внешние библиотеки не \"подтянулись\"','2016-08-02 23:35:00',1,7.33333,0),(6,'dasha',2,'еще раз спасибо!','2016-09-10 05:13:05',0,0,1),(7,'simon',23,'Писать самому форум (если со всеми фичами) задача на полгода(если вы тру), год (если не особо) и год+ если начинающий. Судя по тому что у вас возник такой вопрос - в вашем случае это год+ PS: конечно если речь не о форуме \"с ограниченым функционалом\"','2016-09-11 02:22:12',0,0,0),(8,'mary',23,'Могу порекомендовать движок opensource MVC: http://mesoboard.com/\r\nПример реализации: http://www.dunaydv.ru/','2016-09-11 02:22:12',1,8,0),(9,'dasha',23,'Я разворачивала MvcForum: http://www.mvcforum.com/.\r\nСодержит весь минимальный функционал. Код понятен и вполне расширяем.','2016-09-11 02:33:52',1,8,0),(10,'izzi',23,'если использовать web forms authentication + разделы + темы + сообщения - разделение прав доступа - личка - голосования - репутация и всё это без ajax плюшек, то можно сделать достаточно быстро ','2016-09-11 02:41:30',0,0,0);
...
INSERT INTO `comment_rating` VALUES (1,'dasha',9),(1,'izzi',9),(2,'dasha',0),(2,'izzi',5),(2,'jace',10),(2,'simon',8),(4,'simon',9),(5,'izzi',9),(5,'mary',9),(5,'simon',4),(8,'clary',8),(8,'dasha',8),(9,'clary',8);
...
INSERT INTO `question_rating` VALUES (1,'izzi',5),(1,'jace',8),(1,'simon',6),(4,'izzi',5),(23,'dasha',8),(23,'izzi',6);
...
INSERT INTO `section` VALUES (2,'Java',NULL,7,2,'d9534f',0),(3,'.NET',NULL,3,1,'f0ad4e',0),(4,'Python',NULL,1,0,'5cb85c',0),(5,'C++',NULL,0,0,'337ab7',1),(6,'Java SE',2,3,1,NULL,0),(7,'Java EE',2,2,0,NULL,0),(8,'Java GUI & Java FX',2,1,0,NULL,0),(9,'Java & JDBC, Hibernate',2,1,1,NULL,0),(10,'C# Windows Forms',3,0,0,NULL,0),(11,'C# & ADO.NET, EntityFramework',3,1,0,NULL,0),(12,'ASP.NET MVC',3,1,1,NULL,0),(13,'C# WPF & Silverlight',3,1,0,NULL,0),(14,'Django',4,1,0,NULL,0),(17,'Delphi',NULL,0,0,'2f81d4',0),(18,'Django',4,0,0,NULL,1),(23,'очень важная секция',2,0,0,NULL,1),(24,'yyy',3,0,0,NULL,1),(25,'root1',NULL,1,0,'146e78',1),(26,'new in delphi',17,0,0,NULL,0),(27,'s1',NULL,0,0,'8a2121',1);
...
INSERT INTO `user` VALUES ('admin','Admin','Admin','female','c7ad44cbad762a5da0a452f9e854fdc1e0e7a52a38015f23f3eab1d80b931dd472634dfac71cd34ebc35d16ab7fb8a90c81f975113d6c7538dc69dd8de9077ec','1996-05-02','2016-07-29','darya.kolyadko@gmail.com','admin','active',0,0),('cdcd','Carly','Haylin','female','b9688c84d5dea764fa3fa4fbcbed220c8743e1831604922829fe6061e3bf6ff3fb8c396f448d6f7e9365ca03b805aa9669bbfe642f9100de26542784a8db62cf','2016-08-11','2016-08-31','carly@gmail.com','user','active',0,1),('clary','Кларисса','Феричайлд','female','cd4bca01c28909b5ba67c45c5630d336857a87a54fd964a15e69c6a095256f95f45c919d5f4c46eff3ab2c64c7bd0bc02ec0da91e2970e6956988122db9ee55c','2016-09-29','2016-09-11','clary@gmail.com','user','active',7,0),('Dasha','Даша','Елако','female','3212649967053853e847ea2697e278cd2ecd4c35b73bb5b63c492d7bcd302da5022e1c0828bcb937c42d3cb188e43ea574a733b4d2b468594f7dda19833f7456','1995-12-20','2016-08-03','dasha_elako@mail.ru','user','active',5.52083,0),('dasha','Дарья','Колядко','female','b9688c84d5dea764fa3fa4fbcbed220c8743e1831604922829fe6061e3bf6ff3fb8c396f448d6f7e9365ca03b805aa9669bbfe642f9100de26542784a8db62cf','1996-05-25','2016-07-29','skvoznak-1@mail.ru','user','active',5.52083,0),('izzi','Isabelle','Lightwood','female','b9d5b3965e3dd0fa268ded94ff7dc615e2e770891d261bc9b875030854f8816a2f7dedafce1425baddddd22ee82666626acad9ca3dee7072e5770539757e0d1b','1995-02-14','2016-07-29','izi.lightwood@gmail.com','user','active',5.11111,0),('jace','Jace','Wayland','male','b8a6f8476cd9f7232e72aed0f99ef3d956659fdc74db736bb8f935b7d31825a02bec0409e777ed6d80d355c7affb0c8e7ffd3edc32c54610187869f486ddc3e2','1994-06-14','2016-08-02','jace.w@mail.ru','user','banned',2.5,0),('john.snow','Джон','Сноу','male','1f36d118198f248316cf464d36611b38bf7db49ae6afdc7dced4c72f0c557f6ea7b672f751db392498127a2431a56c770999145a787b8125823769a1a86472a7','1989-07-12','2016-08-24','john.snow@gmail.com','user','banned',0,0),('mary','Мария','Колядко','female','925ece1aeeeec8a68e8921e1a00b889a8895205f2ad3569b38dd1fdf68a909156e893ac49a8c279acd28889e90ed22f53467da7564631189e2f299fe2ad669d7','2004-11-01','2016-08-27','mary.kolyadko@gmail.com','user','active',0,0),('simon','Саймон','Льюис','male','24d802b145245d7fc4400c898af6eddc8e89dd05506f2af39b2612ead8970e31b8522aab07d51c1de0068768ad2ab3fcdf33d66da3ea878ceaf656f469e581dc','1994-08-04','2016-08-02','lewis_simon@gmail.com','user','active',0,0),('ttt','Temperance','Brennan','female','0602611a56f977501462561aacb2f3d57af108c43f5983bc73f26de2129c30fa3aa12da49cd144e800b9a0c378e60c2ec858475aed4579067985ea1bed2f3fb1','2010-02-17','2016-09-04','brennan@gmail.com','user','active',0,0);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_comment_rating`(IN curr_comment_id INT)
BEGIN
DECLARE com_r FLOAT;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_question_rating`(IN curr_question_id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_section_answer_num`(IN curr_section_id INT)
BEGIN
DECLARE s_id INT(11);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_section_question_num`(IN curr_section_id INT)
BEGIN
DECLARE s_id INT(11);
...
-- Dump completed on 2016-09-11  4:26:58
